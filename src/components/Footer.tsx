          ...
          <div className="grid gap-10 md:grid-cols-5">
            ...
            <div className="space-y-5 md:col-span-3">
              ...
              <p className="max-w-md text-sm leading-relaxed text-muted-foreground font-medium">
                CampusXpose — students speaking up, anonymously. Report incidents, share
                experiences, and find your community without fear.
              </p>
              <div
            ...
            <div className="space-y-5 md:col-span-2">
              <h3 className="text-lg font-display font-bold wavy-underline inline-block">
                Navigate
              </h3>
