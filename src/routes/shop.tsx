  ...
  const renderProductCard = (item: Product, isGrid: boolean = false) => {
    ...
    return (
      ...
      >
        ...
        <div className="font-semibold text-sm text-gray-900 line-clamp-2 leading-tight min-h-[40px] mb-1">
          {item.name}
        </div>
          ...
          <main className="max-w-6xl mx-auto bg-white min-h-screen sm:border-x sm:border-gray-100 sm:shadow-sm pb-10">
            ...
            <div className="mt-10 px-5 mb-10">
              <div className="flex items-center justify-between mb-5">
                ...
                <button className="text-purple-700 font-bold text-[13px]">See all</button>
              </div>
                  ...
                  return (
                    <section key={catName}>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <button onClick={() => setSelectedCategory(catName)} className="text-green-600 font-semibold text-sm hover:underline">See all</button>
                      </div>
