...
export const Route = createFileRoute("/global")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "One anonymous platform-wide room where students from every campus talk freely.",
      },
  ...
  return (
    <div className="flex h-[100dvh] flex-col bg-background md:h-[calc(100dvh-4rem)]">
      ...
      <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col-reverse gap-2 overflow-y-auto px-4 py-4">
                        ...
                        >
                          ...
                          <div className="flex flex-wrap items-end justify-end gap-x-2">
                            ...
                            <span
                              className={cn(
                                "shrink-0 text-[10px]",
                                own ? "text-accent-foreground/70" : "text-muted-foreground",
                              )}
                            >
        ...
        {items.length === 0 && (
          <p className="my-auto text-center text-sm text-muted-foreground"></p>
        )}
      </div>
